...
//
// The implementation is derived from golang.org/x/crypto/twofish and is kept
// here to support legacy Thoom protocol handshakes that still rely on
// Twofish-based challenge/response logic.
package twofish
